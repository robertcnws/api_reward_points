...
DJANGO_LIST_SUPPORT_EMAIL_RECEIPTS = env.list('DJANGO_LIST_SUPPORT_EMAIL_RECEIPTS', default=[])
DJANGO_PENDING_USERS_URL = env('DJANGO_PENDING_USERS_URL', default='')
...
AWS_S3_DEFAULT_STORE_PRODUCT_FILE_KEY = env('AWS_S3_DEFAULT_STORE_PRODUCT_FILE_KEY', default='store_products/nws_reward_points_preview.png')
