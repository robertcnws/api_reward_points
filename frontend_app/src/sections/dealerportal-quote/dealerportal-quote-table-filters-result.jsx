...
export function DealerportalQuoteTableFiltersResult({ filters, onResetPage, totalResults, hasNotAll=true, sx }) {
  ...
  const handleResetOwner = useCallback(() => {
    ...
    localStorage.removeItem('dealerportalQuoteFilterOwner');
  }, [filters, onResetPage]);
