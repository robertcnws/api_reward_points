...
import { StoreProductReviewList } from './store-product-review-list';
import { StoreProductReviewNewForm } from './store-product-review-new-form';

// ----------------------------------------------------------------------

export function StoreProductDetailsReview({
  product,
  refetch,
  totalRatings,
  totalReviews,
  ...
  return (
    <>
      ...
      <StoreProductReviewList
        reviews={reviews}
        refetch={refetch}
      />

      <StoreProductReviewNewForm
        open={review.value}
