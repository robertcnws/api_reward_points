...
export function PermissionTableRow({ row, selected, onEditRow, onSelectRow, onDeleteRow, onViewRow, onReturnList }) {
  ...
  return (
    <>
      ...
      <ConfirmDialog
        ...
        title="Delete"
        content={`Are you sure want to delete permission: (${row.name})?`}
        action={
